...
namespace MvcBalloon.Controllers
{
    public class BalloonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Category,Occassion,Color,Size,Shape,Price,Rating")] Balloon balloon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Category,Occassion,Color,Size,Shape,Price,Rating")] Balloon balloon)
        {
            if (id != balloon.Id)
            {
                return NotFound();
